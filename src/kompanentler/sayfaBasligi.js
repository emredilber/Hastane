    ...
    return (
        <View>
            <View style={{
                ...
                justifyContent: 'space-between', flexDirection: 'row', paddingHorizontal: 10,
            }} >
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                    ...
                    <View>
                        ...
                        {/* Hangi ekran açık ise onun adı yazdırılıyor. */}
                        <Text style={{ color: '#fff', fontSize: 13, marginTop: 10 }}>{route.name}</Text>
                    </View>
                </View>
                <View >
                    {/* Menünün açılmasını sağlayan buton gözüksün. */}
                    <TouchableOpacity onPress={() => navigation.openDrawer()} >
                        <Icon name='menu' color='#fff' size={40} />
                    </TouchableOpacity>

                    {/* Hastalar ekranındayken sayfayı yeniden yükleme butonu gözüksün. */}
                    ...
                    {/* Doktor Randevuları ekranındayken sayfayı yeniden yükleme butonu gözüksün. */}
                    ...
                    {/* Randevular ekranındayken sayfayı yeniden yükleme butonu gözüksün. */}
