...
const Item = ({ item, menuAcik, hastaSil, navigation }) => {
    ...
    const kayanButon = () => { // Hastanın kutusu kaydırıldığında ortaya çıkan butonun kodları.
        return (
            <View style={{ flexDirection: 'row', gap: -1, }}>
                <View style={{ flexDirection: 'row', }}>
                    <TouchableOpacity style={{
                        ...
                        onPress={() => {
                            ref.current.close(); navigation.navigate('Hasta Düzenleme', { hastaTc: item.tc });
                        }} >
                    ...
                    <TouchableOpacity style={{
                        ...
                        onPress={() => {
                            ...
                            Alert.alert(
                                ...
                                ], // Hasta silinmek için evete basılıyrsa değişkene TC gönderili ve hasta silinir.
                                { cancelable: true }
                            );
                        }}>
                        <Text style={{ textAlign: 'center', color: '#fff' }}>Hastayı{'\n'} Sil</Text>
        ...
        <Swipeable ref={ref} containerStyle={{ backgroundColor: '#2D567B', borderRadius: 12, }}
            ...
            <View style={{ backgroundColor: '#fff', borderRadius: 12, flexDirection: 'row', }}>
                ...
                <View style={{
                    ...
                    borderTopRightRadius: 12, borderBottomLeftRadius: 12, backgroundColor: '#04479e'
                }}>
