...
const Item = ({ item, menuAcik, doktorSil, navigation }) => {
    ...
    const kayanButon = () => { // Doktorun kutusu kaydırıldığında ortaya çıkan butonun kodları.
        return (
            <View style={{ flexDirection: 'row', gap: -1, }}>
                <View style={{ flexDirection: 'row', }}>
                    <TouchableOpacity style={{
                        ...
                        onPress={() => {
                            ref.current.close(); navigation.navigate('Doktor Düzenleme', { doktorTc: item.tc });
                        }} >
                    ...
                    <TouchableOpacity style={{
                        ...
                        onPress={() => {
                            ...
                            Alert.alert(
                                ...
                                ], // Doktor silinmek için evete basılıyrsa değişkene TC gönderili ve doktor silinir.
                                { cancelable: true }
                            );
                        }}>
                        <Text style={{ textAlign: 'center', color: '#fff' }}>Doktoru{'\n'}Sil</Text>
    ...
    return (
        <Swipeable ref={ref} containerStyle={{ backgroundColor: '#2D567B', borderRadius: 12, }}
            renderRightActions={kayanButon} onSwipeableOpen={() => { menuAcik(item.tc) }} >
            <View style={{ backgroundColor: '#fff', borderRadius: 12, flexDirection: 'row', }}>
                ...
                <View style={{
                    position: 'absolute', paddingVertical: 4, width: 130, alignItems: 'center',
                    right: 0, borderTopRightRadius: 12, borderBottomLeftRadius: 12, backgroundColor: '#04479e'
                }}>
